...
import { PoolsProvider, PoolsContextType } from "@/contexts/pools";

const route = getRouteApi("/trade/$contractAddress");

export default function Terminal() {
  const navigate = useNavigate();
  const { data: poolsData, isLoading: poolsIsLoading, error: poolsError } = usePools();
  ...
  const poolsContext: PoolsContextType = poolsData
  ...
  return (
    <PoolsProvider poolsContext={poolsContext}>
